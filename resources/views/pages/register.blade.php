                       ...
                       <div class="row">
                            <div class="col-md-6 col-12 mb-3">
                                   <div class="form-group">
                                          ...
                                          <input type="text" id="fname" placeholder="First Name" required class="form-control" name="fname">
                                   </div>
                            </div>
                            <div class="col-md-6 col-12 mb-3">
                                   <div class="form-group">
                                          <label for="lname">last Name</label>
                                          <input type="text" id="lname" placeholder="last Name" required class="form-control" name="lname">
                                   </div>
                            </div>
                       </div>
                       <div class="row">

                      ...
                      <div class="collapse navbar-collapse justify-content-end d-md-none" id="navbarSupportedContent">
                           <ul class="navbar-nav">
                               <!-- <li class="nav-item">
                                ...
                                <li class="nav-item">
                                       <a class="nav-link" href="/registration">Registeration</a>
                                </li>
                                ...
                                <li class="nav-item">
                                     <a class="nav-link" href="#" class="image-box">
                                     <img src="{{asset('asset/image/e-ADAPP-logo-23.png')}}"  style="width:15%">
                                     </a>
                                </li>-->
                                <li class="nav-item">
             ...
             <div class="sidebar">
                    ...
                    <div class="sidebar-menu">
                           <ul>
                              ...
                              <li><a href="#" class="active">Farmers</a></li>
